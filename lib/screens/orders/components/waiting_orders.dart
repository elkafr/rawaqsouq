...
import 'package:rawaqsouq/screens/orders/components/waiting_order.dart';
...
class _WaitingOrdersState extends State<WaitingOrders> {
  ...
  Future<List<Order>> _getOrderList() async {
    Map<String, dynamic> results = await _services.get(
        'https://works.rawa8.com/apps/souq/api/dis_buy?lang=${_appState.currentLang}&user_id=${_appState.currentUser.userId}&page=1&done=0');
